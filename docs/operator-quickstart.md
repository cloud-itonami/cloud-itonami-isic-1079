# Operator Quickstart — Other Food Products n.e.c. Manufacturing Coordination

Shortest path from clone to a verified local dry-run for **ISIC 1079** (`cloud-itonami-isic-1079`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1079.git
cd cloud-itonami-isic-1079
```
...
- Blueprint governor key: `seasoningops-governor`
- Likely source path: `seasoningops.governor.cljc`
