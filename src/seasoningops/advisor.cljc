(ns seasoningops.advisor
  "SeasoningOpsAdvisor -- the LLM/decision-maker that proposes operations.

  The advisor operates purely at the proposal level; the Governor (seasoningops.governor)
